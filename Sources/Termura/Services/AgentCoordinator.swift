...
actor AgentCoordinator {
    ...
    nonisolated func computeAgentStateUpdate(
        ...
        // Context window usage = input + cache_read (tokens sent to the model).
        // Output tokens are generated by the model and do not consume the context window;
        // including them would overcount by ~5-10k per turn and cause false early alerts.
