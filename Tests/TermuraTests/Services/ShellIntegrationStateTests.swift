...
extension ShellIntegrationPhase: @retroactive CustomStringConvertible {
    public var description: String {
        switch self {
        case .idle: "idle"
        case .promptActive: "promptActive"
        case let .commandInput(s): "commandInput(\(s))"
        case let .executing(cmd, _): "executing(\(cmd))"
        }
    }
}
