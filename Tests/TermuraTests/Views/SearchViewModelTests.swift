...
final class SearchViewModelTests: XCTestCase {
    ...
    private var viewModel = SearchViewModel(searchService: MockSearchService())
    ...
    override func setUp() async throws {
        ...
        clock = TestClock()
        viewModel = SearchViewModel(searchService: searchService, clock: clock)
    }
    ...
    func testShortQueryClearsResults() async throws {
        ...
        XCTAssertEqual(clock.sleepCallCount, 1)
    }
